...
;(function (window, document, undefined) {
    ...
    var templates = {
        ...
        qq: 'http://connect.qq.com/widget/shareqq/index1.html?url={{URL}}&title={{TITLE}}&source={{SOURCE}}&desc={{DESCRIPTION}}&pics={{IMAGE}}&summary="{{SUMMARY}}"',
...
!function (t, e, n, o) {
    ...
    function i(t) {
        var e = t.currentTarget, o = t.data ? t.data.options : {},
            i = o.selector ? n(o.selector) : t.data ? t.data.items : [], a = n(e).attr("data-fancybox") || "", s = 0,
