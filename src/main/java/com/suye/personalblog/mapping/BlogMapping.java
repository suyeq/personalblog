...
public interface BlogMapping {
    ...
    int addBlog(@Param("title") String title, @Param("imgurl") String imgurl, @Param("describ") String describ,
                @Param("content") String content, @Param("istalk") int istalk, @Param("iscomment") int iscomment,@Param("ispublish")int ispublish);

    @Update("update blog set title=#{title},imgurl=#{imgurl},describ=#{describ},content=#{content},istalk=#{istalk},iscomment=#{iscomment},ispublish=#{ispublish} where id=#{blogId}")
    int modifyBlog(@Param("title") String title, @Param("imgurl") String imgurl, @Param("describ") String describ,
                   @Param("content") String content, @Param("istalk") int istalk, @Param("iscomment") int iscomment,@Param("ispublish")int ispublish,@Param("blogId")int blogId);
